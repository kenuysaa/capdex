            ...
            try {
                ...
                if (userUid != null) {
                    ...
                    _uiState.update { currentState ->
                        currentState.copy(isLoading = false, successMessage = "Cadastro realizado com sucesso!", userUid = userUid)
                    }
                } else {
    ...
    fun loginUser() {
        ...
        viewModelScope.launch {
            try {
                ...
                if (userUid != null) {
                    _uiState.update { currentState ->
                        currentState.copy(isLoading = false, successMessage = "Login realizado com sucesso!", userUid = userUid)
                    }
                } else {
